    ...
    <>
      <nav className={styles.navbar}>
        <div className={styles.container}>
          <div className={styles.mobile_logo}>
            <Link to="/" className={styles.logo} onClick={closeMobileMenu}><img src={logoSrc} alt="Логотип салона красоты" /></Link>
          </div>
          ...
          <div className={styles.desktop_logo}> <Link to="/" className={styles.logo} onClick={closeMobileMenu}><img src={logoSrc} alt="Логотип салона красоты" /></Link> </div>
          ...
          <div className={styles.nav_right}>
            ...
            <button onClick={toggleTheme} className={styles.theme_toggle} aria-label="Переключить тему"> {isDark ? <FiSun size={18} /> : <FiMoon size={18} />} </button>
          </div>
          <button className={styles.menu_toggle} onClick={toggleMobileMenu}> {mobileMenuOpen ? <FiX size={24} /> : <FiMenu size={24} />} </button>
        </div>
      </nav>
      ...
      <div className={`${styles.mobile_menu} ${mobileMenuOpen ? styles.mobile_menu_active : ''}`}>
        <div className={styles.mobile_nav_links}>
          ...
          <Link to="/catalog" onClick={closeMobileMenu} className={styles.mobile_nav_link}>
            Услуги
          </Link>
