...
import { 
  ...
  getAllAppointments, getWorkPhotos, createWorkPhoto, updateWorkPhoto, deleteWorkPhoto,
  getPromotions, createPromotion, updatePromotion, deletePromotion
} from '../controllers/adminController.js';
import { authenticate, authorize } from '../middleware/auth.js';
import { upload, uploadWorkPhoto, uploadPromotion, handleUploadError } from '../middleware/upload.js';
...
// Услуги с поддержкой загрузки фото
router.post('/services', upload.single('photo'), handleUploadError, createService);
router.put('/services/:id', upload.single('photo'), handleUploadError, updateService);
router.delete('/services/:id', deleteService);

// Категории с поддержкой загрузки фото
router.post('/categories', upload.single('photo'), handleUploadError, createCategory);
router.put('/categories/:id', upload.single('photo'), handleUploadError, updateCategory);
